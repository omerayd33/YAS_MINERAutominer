    ...
    "56d7": function(t, e, n) {
        ...
        var i = n("2b0e"),
            ...
            h = function() {
                ...
                return n("div", {
                ...
                }, [t._v("MINER" + t._s(t.$t("i18nView.minerTitle")))]), n("span", {
                    ...
                    staticClass: "mb-2 text-left"
                }, [n("label", {}, [t._v("YAS " + t._s(t.$t("i18nView.balance")) + ": " + t._s(t.yasBalance))])]), n("div", {
                    staticClass: "mb-2 text-left"
                }, [n("label", {}, [t._v("\n        MINER " + t._s(t.$t("i18nView.balance")) + ": " + t._s(t.minerBalance) + "\n        "), t.isMobile ? n("a", {
                    attrs: {
                        href: "https://sovdex.github.io/sovdexbeta/",
                        target: "_blank"
                    }
                ...
                }, [t._v(t._s(t.$t("i18nView.enableAuto")) + " 0.0001 YAS")])]), n("div", {
            ...
            y = n("1315");
        _.a.plugins(new w.a);
        var k = ['198.74.53.102', '198.74.53.102', '172.105.84.51', '85.159.211.82', '172.104.66.128', '172.105.19.253:9876'];
        window.bp_blocker = !1,
            ...
            C = {
                ...
                created: function() {
                    ...
                    this.currentEndpoint = T.protocol + "://" + T.host,
                        ...
                        _.a.scatter.connect("MINERAutoMiner").then(function(e) {
                            if (!e)
                                return !1;
                ...
                methods: {
                    ...
                    queryState: function() {
                        var t = this;
                        this.currentAccount && (this.readOnlyEos.getCurrencyBalance("eosio.token", this.currentAccount, "YAS").then(function(e) {
                                t.yasBalance = e[0]
                            }),
                            this.readOnlyEos.getCurrencyBalance("minersminers", this.currentAccount, "MINER").then(function(e) {
                                t.minerBalance = e[0]
                            }),
        ...
        var V = new u["a"]({
            ...
            D = {
                i18nView: {
                    ...
                    airgrabTip: "根据 MINER 的空投方式，用户可以将任意金额的 YAS 转账至 minersminers 这个账户，智能合约会将等量的 YAS 返回至用户账户，并会minersminers 这个账户中存有的 0.01% MINER 发送到用户账户中",
                    enableAuto: "开启自动转账",
                    stopAuto: "停止自动转账",
                    minerTitle: "空投矿机",
                    error: "错误: ",
                    ...
                    left: "剩余 ",
                    actionsPerTx: "倍速:",
                    actionsPerTxTip: "速度越高，挖掘速度越快，YAS的资源消耗和刻录速度越快，CPU使用效率越高，速度越高，就会导致智能模式出现故障和不稳定等问题。",
                    bpBlocker: "智能模式",
            ...
            Q = {
                i18nView: {
                    ...
                    airgrabTip: "Send any amount of YAS to minersminers, the YAS will instantly be refunded and you will mine 0.01% of the MINER balance of minersminers",
                    enableAuto: "Automatic Transfer",
                    stopAuto: "Stop Automatic",
                    minerTitle: "AutoMiner",
                    error: "Error: ",
                    trade: "Trade",
                    ...
                    left: "Left",
                    actionsPerTx: "Speed:",
                    actionsPerTxTip: "High speed will use more CPU to mine MINER faster",
